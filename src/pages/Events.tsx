...
export default function Events() {
      ...
      if (eventIds.length > 0) {
        ...
        if (prodData) {
          ...
          prodData.forEach(p => {
            ...
            grouped[p.event_id].push({ ...p, isPartnerProduct: true });
          });
  ...
  return (
    <div className="fade-in bottom-nav-safe">
      ...
      {/* ── Header ── */}
      <div className="px-4 pt-6 pb-8 sm:pt-8 sm:pb-10">
        <div className="max-w-7xl mx-auto">
          <div className="glass-panel-dark p-8 sm:p-12 relative overflow-hidden">
